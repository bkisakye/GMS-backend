...
from grants_management.serializers import GrantApplicationSerializer, GrantApplicationReviewSerializer, ProgressReportSerializer, RequestReviewSerializer
...
class NotificationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'user', 'notification_type', 'notification_category', 'text',
                  'timestamp', 'is_read', 'application', 'review', 'subgrantee', 'grant', 'review_recommendation', 'progress_report','chats', 'requests',)
