...
urlpatterns = [
    ...
    path('subgrantees/count/', get_subgrantees_count, name='get_subgrantees_count'),
    path('active-subgrantees/count/', get_active_subgrantees_count, name='get_active_subgrantees_count'),
    path('subgrantees/', get_all_subgrantees, name='get_all_subgrantees'),
    path('subgrantees/<int:user_id>/delete/', delete_subgrantee, name='delete_subgrantee'),
]
